...
namespace LocARNA {
    ...
    */
    ...
    protected:
        ...
        bool track_closing_bp_; //!< whether to track the exact right end of a
                                //!closing basepair for SPARSE

        int multiloop_deletion_; //!< whether to allow aligning an entire branch
    ...
    public:
         ...
         */
        AlignerParams &
        track_closing_bp(bool track_closing_bp) {
            track_closing_bp_ = track_closing_bp;
            return *this;
        }
         ...
         */
        AlignerParams &
        multiloop_deletion(int multiloop_deletion) {
            multiloop_deletion_ = multiloop_deletion;
            return *this;
        }
    ...
    protected:
        ...
        const SparsificationMapper
            *sparsification_mapper_arcsA_; //!<sparsification mapper A indexed
                                           //!by arcs
        const SparsificationMapper
            *sparsification_mapper_arcsB_; //!<sparsification mapper B indexed
                                           //!by arcs
    ...
    public:
         ...
         */
        AlignerNParams &
        sparsification_mapper_arcsA(
            const SparsificationMapper &sparsification_mapper_arcsA) {
            sparsification_mapper_arcsA_ = &sparsification_mapper_arcsA;
            return *this;
        }
        ...
        /**
             * @brief set parameter sparsification mapper indexed by arcs
             * @param sparsification_mapperB scaling sparisification mapper for
         * A
             */
        AlignerNParams &
        sparsification_mapper_arcsB(
            const SparsificationMapper &sparsification_mapper_arcsB) {
            sparsification_mapper_arcsB_ = &sparsification_mapper_arcsB;
            return *this;
        }
