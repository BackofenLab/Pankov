...
namespace LocARNA {
    ...
    private:
        bool trace_debugging_output; //!< a static switch to enable generating
                                     //!debugging logs
    ...
    protected:
        ...
        const SparsificationMapper
            &mapper_arcsA; //!< sparsification mapping for seq A indexed by arcs
        const SparsificationMapper
            &mapper_arcsB; //!< sparsification mapping for seq B indexed by arcs
        ...
        protected:
            const AlignerNN
                *alignerNN_; //!< aligner object for that the view is provided
        public:
            /**
             ...
             */
            explicit UnmodifiedScoringViewNN(const AlignerNN *alignerNN)
                : alignerNN_(alignerNN){};
        ...
        public:
             ...
             * already
             */
            explicit ModifiedScoringViewNN(const AlignerNN *alignerNN)
        ...
        ModifiedScoringViewNN mod_scoring_view;   //!< Modified scoring view for
        ...
        void
        init_M_E_F(ArcIdx idxA, ArcIdx idxB, ScoringView sv);
        ...
        */
         ...
         */
        pos_type
        get_arc_leftend(ArcIdx &arc, bool isA);
         ...
         */
        void
        fill_IA_entries(ArcIdx idxA, Arc arcB, pos_type max_ar);
         ...
         */
        void
        fill_IB_entries(Arc arcA, ArcIdx idxB, pos_type max_br);
        ...
        */
        template <class ScoringView>
        infty_score_t
        compute_E_entry(seq_pos_t al_seq_pos,
                        matidx_t i_index,
                        matidx_t j_index,
                        seq_pos_t i_seq_pos,
        ...
        */
        template <class ScoringView>
        infty_score_t
        compute_F_entry(seq_pos_t bl_seq_pos,
                        matidx_t i_index,
                        matidx_t j_index,
                        seq_pos_t i_seq_pos,
                        seq_pos_t i_prev_seq_pos,
         ...
         */
        void
        fill_M_entries(const Arc &arcA, const Arc &arcB);
