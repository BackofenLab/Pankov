...
namespace LocARNA {
    ...
    public:
         ...
         * If conditional_scores is set, this closing arcs are used to calculate
         * the conditional prob/score
         ...
         */
        void
        set_closing_arcs(const Arc &closingA, const Arc &closingB);
    ...
    public:
        ...
        arcmatch(const BasePairs__Arc &arcA,
                 ...
                 bool stacked = false,
                 bool non_cond = false) const;

        score_t
        arcDel_conditional(const Arc &arcX,
                           const Sequence &seqX,
